...
public final class NavActivity_MembersInjector implements MembersInjector<NavActivity> {
  ...
  public NavActivity_MembersInjector(
  ...
  public static MembersInjector<NavActivity> create(
      Provider<DispatchingAndroidInjector<Fragment>> supportFragmentInjectorProvider,
      Provider<DispatchingAndroidInjector<android.app.Fragment>>
          frameworkFragmentInjectorProvider) {
    return new NavActivity_MembersInjector(
        supportFragmentInjectorProvider, frameworkFragmentInjectorProvider);
  }

  @Override
  public void injectMembers(NavActivity instance) {
